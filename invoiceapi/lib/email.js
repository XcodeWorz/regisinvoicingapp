...
exports.activate_email = function(username, email, activateLink) {
	const emailData = `<!doctype html>
  <html>
  <head>
          ...
          <tr>
            <td>
              ...
              <table class="btn-primary" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td>
                    <a href="`+constants.host+`/confirm?email=`+email+`&active_link=`+activateLink+`">Verify Your express-mvc-generator</a>
                  </td>
                </tr>
              </table>
              <!-- /button -->
