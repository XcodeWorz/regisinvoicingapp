...
class Editestimate extends Component {
    ...
    componentDidMount() {
      ...
      .then(([res1,res2,res3,res4]) => {
        ...
        res1.contacts.length > 0 && res1.contacts.map(function(item,index) {
            ...
            let resestimateDate = new Date(res2.invoices[0].estimateDate);
            this.setState(
                          {
                            ...
                            estimateNo:res2.invoices[0].estimateNo,
                            orderNo:res2.invoices[0].orderNo,
                            estimateDate:resestimateDate,
                            ...
                            taxSlabs:res4,
                            isTaxExclusive:res2.invoices[0].isTaxExclusive,
                            isRegisteredUnderGST:res3.settings[0].isRegisteredUnderGST,
                            customerNotes:(res2.invoices[0].customerNotes && res2.invoices[0].customerNotes !=="undefined" && res2.invoices[0].customerNotes !==null)?res2.invoices[0].customerNotes:(res3.settings[0].invoiceCustomerNotes && res3.settings[0].invoiceCustomerNotes!=="undefined" && res3.settings[0].invoiceCustomerNotes!==null)?res3.settings[0].invoiceCustomerNotes:'',
                            termsAndConditions:(res2.invoices[0].termsAndConditions && res2.invoices[0].termsAndConditions !=="undefined" && res2.invoices[0].termsAndConditions !==null)?res2.invoices[0].termsAndConditions:(res3.settings[0].invoiceTermsAndConditions && res3.settings[0].invoiceTermsAndConditions!=="undefined" && res3.settings[0].invoiceTermsAndConditions!==null)?res3.settings[0].invoiceTermsAndConditions:'',
    ...
    openReason(status) {
        this.setState({ showModalReason: true, modalerrors:{}, estimateStatus:status });
    }
    ...
    handleSubmitModalReason(e) {
        ...
        if(!this.validateFormModalReason())
        {
            ...
            fetch(Constants.BASE_URL_API+"editestimate",
            {
                method: "POST",
                mode:'cors',
                body: new URLSearchParams({
                    ...
                    status:this.state.estimateStatus,
    ...
    validateForm()
    {
        ...
        {
            error_flag = true;
            errors['estimateNo'] = "Please enter estimate number!";
        }
            ...
            <div className="main-panel">
                <nav className="header navbar">
                    <div className="header-inner">
                        ...
                        <a className="navbar-item navbar-spacer-right navbar-heading hidden-md-down" href="javascript:void(0);">
                            <span className="tophead-txt">Estimates >> Edit Estimate</span>
                ...
                <div className="main-content">
                    <div className="content-view">
                        <div className="card">
                            <div className="sec-t-container m-b-2"><h4 className="card-title">Edit Estimate</h4></div>
                                        ...
                                        <div className="row">
                                            <div className="col-md-4">
                                                <fieldset className="form-group">
                                                    ...
                                                    <input type="text" className="form-control form-control-md" name="estimateNo" disabled onChange={this.handleChange} value={estimateNo}/>
