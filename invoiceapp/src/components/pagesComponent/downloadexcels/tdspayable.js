...
class Tdspayable extends Component {
    constructor(props) {
    super(props);
    this.state = {
            searchFilterYear:'',
    ...
    makeList()
    {
        ...
        Promise.all([
        fetch(Constants.BASE_URL_API+"tdsreceivable",
        {
            method: "POST",
            mode:'cors',
        ...
        <Router>
            ...
            <div className="main-panel">
                ...
                <div className="header-inner">
                    ...
                    <span className="tophead-txt">TDS Tax Amount</span>
                        ...
                        <div className="card">
                         ...
                         <div className="row">
                            ...
                            <div className="card">
                                ...
                                <h4 className="card-title">TDS Receivable - 
                                &nbsp;<i className="fa fa-inr" aria-hidden="true"></i>
                                {
                                    (this.state.receivable && this.state.receivable!=="undefined" && this.state.receivable !==null &&
                                    this.state.receivable.length > 0)?
                                    this.state.receivable.reduce((sum, i) => (
                                            sum += i.taxAmount
                                            ), 0).toFixed(2)
                                            :
                                            "0.00"
                                ...
                                <div className="card-block">
                                    <div className="emp-meta">
                                        <table className="table table-bordered m-b-0">
                                            ...
                                            {
                                                this.state.receivable && this.state.receivable!=="undefined" && this.state.receivable !==null &&
                                                this.state.receivable.length > 0 && this.state.receivable.map(function(item,index) {
                                                return <tr>
                                                    <td>{++index}</td>
                                                    <td>
                                                        <b>Invoice No:</b>
