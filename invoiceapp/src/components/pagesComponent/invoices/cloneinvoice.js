...
class Cloneinvoice extends Component {
    constructor(props) {
        super(props);

        //Check URL Path contains /editinvoice 
        this.isInvoice = (this.props.location.pathname.includes(Constants.CLONE_INVOICE_PATH))?true:false;
            ...
            <div className="main-panel">
                <nav className="header navbar">
                    <div className="header-inner">
                        ...
                        <a className="navbar-item navbar-spacer-right navbar-heading hidden-md-down" href="javascript:void(0);">
                            <span className="tophead-txt">{this.isInvoice?"Invoices >> Clone Invoice":""}</span>
                ...
                <div className="main-content">
                    <div className="content-view">
                        <div className="card">
                            <div className="sec-t-container m-b-2"><h4 className="card-title">{this.isInvoice?"Clone Invoice":""}</h4></div>
