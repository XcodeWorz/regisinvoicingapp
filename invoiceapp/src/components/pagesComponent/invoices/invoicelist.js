...
class Invoicelist extends Component {
    ...
    this.isInvoice = (this.props.location.pathname === Constants.LIST_INVOICE_PATH)?true:false;
    ...
    async onChangePage(page) {
        if(page != this.state.pageNo){
            this.setState({
                ...
                fetch(Constants.BASE_URL_API+"getinvoices",
                {
                    method: "POST",
                    mode:'cors',
    ...
    async downloadPdf(invoiceId,isEmail)
   {
    ...
    return (
            ...
            <div className="main-panel">
                <nav className="header navbar">
                  <div className="header-inner">
                    ...
                    <a className="navbar-item navbar-spacer-right navbar-heading hidden-md-down" href="javascript:void(0);">
                      <span className="tophead-txt">{this.isInvoice?"Invoices >> View List":""}</span>
                ...
                <div className="main-content">
                    ...
                    <div className="card">
                        ...
                        <a className="btn btn-primary add-new" href={this.isInvoice?"/addinvoice":""}>
     ...
     <Modal show={this.state.showModal} onHide={this.close}>
          ...
          <Modal.Body>
            <div className="wr-msg">Are you sure you want to clone <br/> {this.isInvoice?"Invoice No: ":""} {this.state.cloneInvoiceNo}?</div>
