...
class Addinvoice extends Component {
    constructor(props) {
        ...
        //Check URL Path is /addinvoice 
        this.isInvoice = (this.props.location.pathname === Constants.ADD_INVOICE_PATH)?true:false;
        ...
        .then(([res1, res2, res3, res4]) => {
            ...
            if(customerFlag)
            {
                this.setState({
                    ...
                    customerNotes:(res3.settings[0].invoiceCustomerNotes && res3.settings[0].invoiceCustomerNotes!=="undefined" && res3.settings[0].invoiceCustomerNotes!==null && this.isInvoice)?res3.settings[0].invoiceCustomerNotes:'',
                    termsAndConditions:(res3.settings[0].invoiceTermsAndConditions && res3.settings[0].invoiceTermsAndConditions!=="undefined" && res3.settings[0].invoiceTermsAndConditions!==null && this.isInvoice)?res3.settings[0].invoiceTermsAndConditions:'',
                    taxSlabs:res4,
                ...
                <div className="main-panel">
                    <nav className="header navbar">
                        <div className="header-inner">
                            ...
                            <span className="tophead-txt">{this.isInvoice?"Invoices >> Add New":""}</span>
                    ...
                    <div className="main-content">
                        <div className="content-view">
                            <div className="card">
                                <div className="sec-t-container m-b-2"><h4 className="card-title">{this.isInvoice?"Create Invoice":""}</h4></div>
                                ...
                                <div id="userDiv">
                                    ...
                                    <form action="javascript:void(0);" id="contact_form">
                                        <fieldset className="form-group">
                                            ...
                                            <div className="row">
                                            {
                                                ...
                                                <div className="col-md-6">
                                                    <span className="anc-child"><a href="/addcontact"><i class="fa fa-plus" aria-hidden="true"></i>New Customer</a></span>
                                                </div>
                                            </div>
...

                                        {
                                            ...
                                            <button className="btn btn-primary btn-md" type="button" id="contact_submit" onClick={this.handleSubmit.bind(this,Constants.DUE_ON_DATE_STATUS)}>
                                            Save and Send
                                            </button>
                ...
                <Modal show={this.state.showModal} onHide={this.closeModal}>
                    ...
                    <Modal.Body>
                        ...
                        <form action="javascript:void(0);" onSubmit={this.handleSubmitModal} id="contact_form">
                            ...
                            <fieldset className="form-group">
                                <label for="name">
                                {this.isInvoice?"Selling":"Purchase"} Price<span className="mandatory">*</span>
                                </label>
