                        ...
                        <table className="table m-b-0">
                            <tr>
                                ...
                                <td width="35%">
                                    ...
                                    <p  className="font-bold">{(this.props.invoices.invoiceCompanyName && this.props.invoices.invoiceCompanyName!=="undefined" && this.props.invoices.invoiceCompanyName!==null)?this.props.invoices.invoiceCompanyName:''}</p>
                            ...
                            <td>
                                <table className="table-header-info">
                                    <tr>
                                        ...
                                        <td>
                                            : {(this.props.invoices.invoiceNo && this.props.invoices.invoiceNo!=="undefined" && this.props.invoices.invoiceNo!==null)?this.props.invoices.invoiceNo:''}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            : {(this.props.invoices.invoiceDate && this.props.invoices.invoiceDate!==null)?(new Date(this.props.invoices.invoiceDate).getDate()) + "-" + (new Date(this.props.invoices.invoiceDate).getMonth() + 1) + "-" + (new Date(this.props.invoices.invoiceDate).getFullYear()):''}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            : {(this.props.invoices.invoice_status && this.props.invoices.invoice_status!==null)?this.props.invoices.invoice_status:''}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            : {(this.props.invoices.dueDate && this.props.invoices.dueDate!==null)?(new Date(this.props.invoices.dueDate).getDate()) + "-" + (new Date(this.props.invoices.dueDate).getMonth() + 1) + "-" + (new Date(this.props.invoices.dueDate).getFullYear()):''}
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-5">
                            <table className="subtotal-table">
                                <tr>
                                    <td>Subtotal</td>
                                    <td>: {this.props.invoices.subTotal}</td>
                                </tr> 
                                {
                                ...
                                <tr className="grey-bg" style={{fontWeight:600}}>
                                    <td>Total</td>
                                    <td>: <i className="fa fa-inr" aria-hidden="true"></i>{(this.props.invoices.totalAmount && this.props.invoices.totalAmount!=="undefined" && this.props.invoices.totalAmount!==null)?this.props.invoices.totalAmount.toFixed(2):0 }</td>
                                </tr> 
                            </table>
                        </div>
                    </div>
